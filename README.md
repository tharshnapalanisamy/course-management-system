...
4. The Course Management System will be displayed.
...
3. Enter the instructor name.
4. Enter the course duration.
5. Enter the credits.
6. Select the course status.
7. Click Add Course.
